...
This plugin uses a custom WordPress/PHP port of a [Java implementation](https://code.google.com/archive/p/jviolajones/) of the [Viola/Jones](https://en.wikipedia.org/wiki/Viola%E2%80%93Jones_object_detection_framework) object detection algorithm.  Very technical stuff. Basically, you need to know that it is not 100% effective. But the idea is to improve its effectiveness in subsequent versions.
